...
function MenuBar({
  ...
  return (
    <div
      className={cn(
        'flex gap-2 border-b border-gray-200 pb-4',
        toolbarClassName,
      )}
    >
      <div className="flex flex-wrap gap-2">
        ...
        {/* {toolbarConfig.clearMarks && (
          <button
            type="button"
            onClick={() => editor.chain().focus().unsetAllMarks().run()}
            className={cn(
              'rounded-md border border-gray-200 px-2 py-1 text-sm hover:bg-gray-50',
              editorState.canClearMarks && 'bg-gray-100',
            )}
          >
            Clear marks
          </button>
        )} */}
        {/* {toolbarConfig.clearNodes && (
          <button
            type="button"
        ...
        {/* {toolbarConfig.undo && (
          <button
            ...
            className={cn('rounded-md border border-gray-200 px-2 py-1 text-sm hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed')}
          >
            Undo
          </button>
        )} */}
