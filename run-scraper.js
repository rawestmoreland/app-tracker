import { linkedinScraper } from './lib/scraper/dist/index.js';
...
async function runScraper() {
  ...
  console.log(`Generated URL: https://www.linkedin.com/company/${companyName.toLowerCase().replace(/\s+/g, '-').replace(/[^a-z0-9-]/g, '')}/about/`);
